        ...
        return __generator(this, function (_a) {
            ...
            styleSheets.forEach(function (sheet) {
                if ('cssRules' in sheet) {
                    try {
                        (0, util_1.toArray)(sheet.hasOwnProperty('cssRules')).forEach(function (item, index) {
            ...
            return [2 /*return*/, Promise.all(deferreds).then(function () {
                    ...
                    styleSheets.forEach(function (sheet) {
                        if ('cssRules' in sheet) {
                            try {
                                (0, util_1.toArray)(sheet.hasOwnProperty('cssRules')).forEach(function (item) {
                                    ret.push(item);
                                });
                            }
                            catch (e) {
